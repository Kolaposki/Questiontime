<template>
  <div class="single-question mt-2">
    <div v-if="question" class="container">
      ...
      <!-- Show edit and delte buttons only if the logged in user is the author of question -->
    ...
    getQuestionData() {
      ...
      apiService(endpoint)
        .then(data => {
          if (data) {
            this.question = data;
            this.userHasAnswered = data.user_has_answered; // if the current user has already answered the question
